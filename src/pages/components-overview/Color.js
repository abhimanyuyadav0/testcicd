    ...
    <Grid container spacing={3}>
      <Grid item xs={12} sm={6} md={4}>
        <MainCard title="Primary Color" codeHighlight>
          <Stack>
            <ColorBox bgcolor="primary.lighter" data={{ label: 'Blue-1', color: '#f83201' }} title="primary.lighter" dark />
            <ColorBox bgcolor="primary.100" data={{ label: 'Blue-2', color: '#f83201' }} title="primary[100]" dark />
